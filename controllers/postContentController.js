...
const postContentDetails = {
    postContentData : async (req, res) => {
        ...
        const { adVideoLink,dateAndTime, questionType, imageURL, questionTypeID, videoType, questionDescription, option, videoURL, 
            ...
            optionFour, optionFive, correctOption, brandName, isSample, movieName, movieDesc, movieRuntime, intervalTime, productionHouse, startDate, endDate, posterImage,movieURLPartOne, movieURLPartTwo,
          } = req.body;
            ...
            ${imageURL},${text}, ${imageName}, ${correctOption}, ${padx1}, ${padx2}, ${padx3}, ${padx4}, ${padx5}, ${x1}, ${x2}, ${x3}, ${x4}, ${x5},
             ...
             if(questionID){
               ...
               if(resultAD){
                ...
                const insertMovieQuery = `INSERT INTO movieTable (movieName, movieDesc, movieURLPartOne, movieURLPartTwo, movieRuntime, intervalTime, productionHouse, dateTime, startDate, endDate, posterImage,displayToggle, userResponseToggle,  isDeleted, isExpired, createdAt, updatedAt)
               VALUES(${movieName}, ${movieDesc}, '${movieURLPartOne}', '${movieURLPartTwo}', ${movieRuntime}, ${intervalTime}, ${productionHouse} , ${dateAndTime}, ${startDate}, ${endDate}, ${posterImage}, ${displayToggle}, ${userResponseToggle}, false, false, NOW(), NOW())`;
